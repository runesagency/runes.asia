export const en = {
    header: {
        title: "Redefining Brand New Experiences For Brands & Users.",
        descriptions: [
        ...
        links: ["Behind The Runes", "The Great Journey"],
    },
    about: {
        title: "Small Team With High Values",
        description:
            "Founded in the early of 2022, we found that so many brands or products are doing the same things as other businesses. As a result, these brands almost got no exclusivity at all.\n\nKnowing that, we, at Runes, dedicating ourselves to helping brands & users creating a better identity for their business, products, or services.",
    },
    teams: {
...
export const id: typeof en = {
    header: {
        title: "Membuat Pengalaman Baru Untuk Bisnis dan Pengguna.",
        descriptions: [
            "Kami percaya bahwa setiap proses itu seharusnya lebih mudah dan simpel untuk semua orang.",
            "Dan kami juga percaya bahwa setiap produk hebat itu harus di distribusikan ke segala pihak tanpa terkecuali.",
        ],
        links: ["Di Balik Runes", "Perjalanan Kami"],
    },
    about: {

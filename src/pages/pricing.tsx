        ...
        <article className="w-full border-8 flex flex-col text-black font-poppins overflow-hidden" style={{ borderColor: props.color }}>
            <div className="grid gap-8 bg-opacity-20 p-10 h-max" style={{ backgroundColor: props.color }}>
                ...
                <div className="grid gap-2">
                    <h6 className="text-sm">Level {props.level}</h6>
                ...
                <div className="flex flex-wrap items-center gap-3 text-sm">
                    {props.keyFeatures.map((feature, index) => (
                        <Button.Secondary active key={index}>
                            {feature}
                        </Button.Secondary>
                    ))}
                </div>
            ...
            <div className="flex flex-col justify-between gap-10 p-10 h-full">
                <div className="grid gap-5">
                    ...
                    <div className="grid gap-2 fill-navy">
                        {props.checkFeatures.map((feature, index) => (
                    ...
                    <div className="grid gap-2">
                        {props.crossFeatures.map((feature, index) => (
...
export default function PricingPage() {
    const pricings: PricingBlockProps[] = [
        {
            level: 10,
            price: "Rp599K",
            title: "Associate",
            ...
            checkFeatures: [
                ...
                "Simple Motion Graphics & Video Editing",
            ],
            crossFeatures: [
                "Lifetime Revisions", //
            ...
            description: "The best way to get your brand online.",
            keyFeatures: [
                "1 Brand", //
                "1 Active Task",
            ],
